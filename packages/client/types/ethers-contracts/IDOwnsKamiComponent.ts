...
export interface IDOwnsKamiComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsKamiComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsKamiComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsKamiComponentInterface;
