...
export interface IDOwnsFlagComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsFlagComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsFlagComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsFlagComponentInterface;
