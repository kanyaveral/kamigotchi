...
export interface ItemBurnSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ItemBurnSystem extends BaseContract {
  connect(runner?: ContractRunner | null): ItemBurnSystem;
  waitForDeployment(): Promise<this>;

  interface: ItemBurnSystemInterface;
  ...
  executeTyped: TypedContractMethod<
    [indices: BigNumberish[], amts: BigNumberish[]],
    [string],
    "nonpayable"
  >;
