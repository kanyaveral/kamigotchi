...
export interface IsListingComponentInterface extends utils.Interface {
  functions: {
...
export interface IsListingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsListingComponentInterface;
