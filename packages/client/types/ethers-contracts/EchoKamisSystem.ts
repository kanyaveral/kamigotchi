...
export interface EchoKamisSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface EchoKamisSystem extends BaseContract {
  connect(runner?: ContractRunner | null): EchoKamisSystem;
  waitForDeployment(): Promise<this>;

  interface: EchoKamisSystemInterface;
