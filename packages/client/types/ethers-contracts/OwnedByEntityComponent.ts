...
export interface OwnedByEntityComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ID"
      | "authorizeWriter"
...
export interface OwnedByEntityComponent extends BaseContract {
  connect(runner?: ContractRunner | null): OwnedByEntityComponent;
  waitForDeployment(): Promise<this>;

  interface: OwnedByEntityComponentInterface;
  ...
  getValue: TypedContractMethod<[entity: BigNumberish], [bigint], "view">;
  ...
  "set(uint256,uint256)": TypedContractMethod<
    [entity: BigNumberish, ownedByEntity: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[ownedByEntity: BigNumberish], [bigint[]], "view">;
  getFunction(
