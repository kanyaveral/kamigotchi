...
export interface HasFlagComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface HasFlagComponent extends BaseContract {
  connect(runner?: ContractRunner | null): HasFlagComponent;
  waitForDeployment(): Promise<this>;

  interface: HasFlagComponentInterface;
