...
export interface IDOwnsQuestComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsQuestComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsQuestComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsQuestComponentInterface;
