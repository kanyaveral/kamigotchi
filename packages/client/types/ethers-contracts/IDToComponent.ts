...
export interface IDToComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDToComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDToComponent;
  waitForDeployment(): Promise<this>;

  interface: IDToComponentInterface;
