...
export interface AccountRegisterSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AccountRegisterSystem extends BaseContract {
  connect(runner?: ContractRunner | null): AccountRegisterSystem;
  waitForDeployment(): Promise<this>;

  interface: AccountRegisterSystemInterface;
