...
export interface IDOwnsRelationshipComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsRelationshipComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsRelationshipComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsRelationshipComponentInterface;
