...
export interface IdTargetComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IdTargetComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IdTargetComponent;
  waitForDeployment(): Promise<this>;

  interface: IdTargetComponentInterface;
