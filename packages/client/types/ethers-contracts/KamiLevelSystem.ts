...
export interface KamiLevelSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiLevelSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiLevelSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiLevelSystemInterface;
