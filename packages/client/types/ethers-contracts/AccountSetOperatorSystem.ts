...
export interface AccountSetOperatorSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AccountSetOperatorSystem extends BaseContract {
  connect(runner?: ContractRunner | null): AccountSetOperatorSystem;
  waitForDeployment(): Promise<this>;

  interface: AccountSetOperatorSystemInterface;
  ...
  ): TypedContractMethod<[operator: AddressLike], [string], "nonpayable">;
  getFunction(
