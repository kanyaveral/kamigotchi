...
export type FunctionSelectorStruct = {
  contr: PromiseOrValue<string>;
...
export interface FunctionComponentInterface extends utils.Interface {
  functions: {
    ...
    "getEntitiesWithValue((address,bytes4))": FunctionFragment;
    ...
    "set(uint256,(address,bytes4))": FunctionFragment;
    "setBatch(uint256[],bytes[])": FunctionFragment;
    "setBatch(uint256[],(address,bytes4)[])": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getEntitiesWithValue((address,bytes4))"
      | "getRaw"
      | "getRawBatch"
      | "getSchema"
      | "has"
      ...
      | "setBatch(uint256[],(address,bytes4)[])"
      | "size"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((address,bytes4))",
    values: [FunctionSelectorStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(address,bytes4))",
    values: [PromiseOrValue<BigNumberish>, FunctionSelectorStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setBatch(uint256[],(address,bytes4)[])",
    values: [PromiseOrValue<BigNumberish>[], FunctionSelectorStruct[]]
  ): string;
  encodeFunctionData(
...
export interface FunctionComponent extends BaseContract {
