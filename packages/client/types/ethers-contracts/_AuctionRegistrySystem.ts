...
export interface _AuctionRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addRequirement"
...
export interface _AuctionRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _AuctionRegistrySystem;
  waitForDeployment(): Promise<this>;

  interface: _AuctionRegistrySystemInterface;
  ...
  remove: TypedContractMethod<[itemIndex: BigNumberish], [void], "nonpayable">;
