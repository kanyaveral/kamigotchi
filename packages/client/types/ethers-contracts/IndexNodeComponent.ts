...
export interface IndexNodeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexNodeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexNodeComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexNodeComponentInterface;
