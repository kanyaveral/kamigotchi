...
export interface IndexKamiComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexKamiComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexKamiComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexKamiComponentInterface;
