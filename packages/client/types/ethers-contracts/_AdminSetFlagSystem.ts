...
export interface _AdminSetFlagSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _AdminSetFlagSystem extends BaseContract {
  connect(runner?: ContractRunner | null): _AdminSetFlagSystem;
  waitForDeployment(): Promise<this>;

  interface: _AdminSetFlagSystemInterface;
  ...
  executeTyped: TypedContractMethod<
    [ids: BigNumberish[], flagType: string, state: boolean],
    [string],
    "nonpayable"
  >;
