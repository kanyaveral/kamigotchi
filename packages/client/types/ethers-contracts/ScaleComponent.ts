...
export interface ScaleComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface ScaleComponent extends BaseContract {
  connect(runner?: ContractRunner | null): ScaleComponent;
  waitForDeployment(): Promise<this>;

  interface: ScaleComponentInterface;
