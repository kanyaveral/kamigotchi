...
export interface _AuthManageRoleSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addRole"
...
export interface _AuthManageRoleSystem extends BaseContract {
  connect(runner?: ContractRunner | null): _AuthManageRoleSystem;
  ...
  addRole: TypedContractMethod<
    [target: AddressLike, role: string],
    [void],
    "nonpayable"
  >;
