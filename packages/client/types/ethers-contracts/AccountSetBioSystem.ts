...
export interface AccountSetBioSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AccountSetBioSystem extends BaseContract {
  connect(runner?: ContractRunner | null): AccountSetBioSystem;
  waitForDeployment(): Promise<this>;

  interface: AccountSetBioSystemInterface;
  ...
  executeTyped: TypedContractMethod<[bio: string], [string], "nonpayable">;
  ...
  ): TypedContractMethod<[bio: string], [string], "nonpayable">;
  getFunction(
