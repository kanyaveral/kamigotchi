...
export interface IndexNPCComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexNPCComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexNPCComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexNPCComponentInterface;
