...
export interface AccountSetNameSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AccountSetNameSystem extends BaseContract {
  connect(runner?: ContractRunner | null): AccountSetNameSystem;
  ...
  executeTyped: TypedContractMethod<[name: string], [string], "nonpayable">;
