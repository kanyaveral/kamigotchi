...
export interface KamiTransferrerComponentInterface extends utils.Interface {
  functions: {
...
export interface KamiTransferrerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KamiTransferrerComponentInterface;
