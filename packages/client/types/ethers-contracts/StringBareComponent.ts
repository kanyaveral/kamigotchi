...
export interface StringBareComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface StringBareComponent extends BaseContract {
  connect(runner?: ContractRunner | null): StringBareComponent;
  waitForDeployment(): Promise<this>;

  interface: StringBareComponentInterface;
