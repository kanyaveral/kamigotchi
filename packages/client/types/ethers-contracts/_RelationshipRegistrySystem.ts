...
export interface _RelationshipRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _RelationshipRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _RelationshipRegistrySystem;
  ...
  remove: TypedContractMethod<
    [npcIndex: BigNumberish, relIndex: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  update: TypedContractMethod<[arguments: BytesLike], [void], "nonpayable">;
