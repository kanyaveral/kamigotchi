...
export interface ValueComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface ValueComponent extends BaseContract {
  connect(runner?: ContractRunner | null): ValueComponent;
