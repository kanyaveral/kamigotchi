...
export interface RerollComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface RerollComponent extends BaseContract {
  connect(runner?: ContractRunner | null): RerollComponent;
  waitForDeployment(): Promise<this>;

  interface: RerollComponentInterface;
