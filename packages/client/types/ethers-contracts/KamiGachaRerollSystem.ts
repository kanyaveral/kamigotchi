...
export interface KamiGachaRerollSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiGachaRerollSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiGachaRerollSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiGachaRerollSystemInterface;
  ...
  reroll: TypedContractMethod<
    [kamiIDs: BigNumberish[]],
    [bigint[]],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "reroll"
  ): TypedContractMethod<[kamiIDs: BigNumberish[]], [bigint[]], "nonpayable">;
  getFunction(
