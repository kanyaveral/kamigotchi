...
export interface IndexComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexComponentInterface;
