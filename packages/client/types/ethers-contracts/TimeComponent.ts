...
export interface TimeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface TimeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TimeComponent;
  waitForDeployment(): Promise<this>;

  interface: TimeComponentInterface;
