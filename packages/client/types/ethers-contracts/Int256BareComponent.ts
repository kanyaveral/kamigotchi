...
export interface Int256BareComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
  ...
  encodeFunctionData(
    functionFragment: "dec(uint256,int256)",
  ...
  encodeFunctionData(
    functionFragment: "inc(uint256[],int256)",
    values: [BigNumberish[], BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "inc(uint256[],int256[])",
...
export interface Int256BareComponent extends BaseContract {
  connect(runner?: ContractRunner | null): Int256BareComponent;
  waitForDeployment(): Promise<this>;

  interface: Int256BareComponentInterface;
  ...
  "dec(uint256,int256)": TypedContractMethod<
  ...
  "inc(uint256[],int256)": TypedContractMethod<
    [entities: BigNumberish[], value: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  "set(uint256,int256)": TypedContractMethod<
    [entity: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "dec(uint256,int256)"
  ): TypedContractMethod<
    [entity: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "inc(uint256[],int256)"
  ): TypedContractMethod<
    [entities: BigNumberish[], value: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "set(uint256,int256)"
  ): TypedContractMethod<
    [entity: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
