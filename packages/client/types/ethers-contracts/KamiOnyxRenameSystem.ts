...
export interface KamiOnyxRenameSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiOnyxRenameSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiOnyxRenameSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiOnyxRenameSystemInterface;
