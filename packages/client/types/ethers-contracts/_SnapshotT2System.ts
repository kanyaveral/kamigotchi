...
export interface _SnapshotT2SystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _SnapshotT2System extends BaseContract {
  connect(runner?: ContractRunner | null): _SnapshotT2System;
  waitForDeployment(): Promise<this>;

  interface: _SnapshotT2SystemInterface;
  ...
  dropKillRewards: TypedContractMethod<
    [arguments: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "dropKillRewards"
