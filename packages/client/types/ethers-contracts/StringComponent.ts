...
export interface StringComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface StringComponent extends BaseContract {
  connect(runner?: ContractRunner | null): StringComponent;
  ...
  "getEntitiesWithValue(string)": TypedContractMethod<
    [value: string],
    [bigint[]],
    "view"
  >;
  ...
  "set(uint256,string)": TypedContractMethod<
    [entity: BigNumberish, value: string],
    [void],
    "nonpayable"
  >;
  ...
  "set(uint256[],string[])": TypedContractMethod<
    [entities: BigNumberish[], values: string[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getEntitiesWithValue(string)"
  ...
  getFunction(
    nameOrSignature: "set(uint256,string)"
  ): TypedContractMethod<
    [entity: BigNumberish, value: string],
    [void],
    "nonpayable"
