...
export interface IndexSkillComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexSkillComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexSkillComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexSkillComponentInterface;
