...
export interface _RegistrySetModSystemInterface extends utils.Interface {
  functions: {
...
export interface _RegistrySetModSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _RegistrySetModSystemInterface;
