...
export interface _WorldWhitelistSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _WorldWhitelistSystem extends BaseContract {
  connect(runner?: ContractRunner | null): _WorldWhitelistSystem;
  waitForDeployment(): Promise<this>;

  interface: _WorldWhitelistSystemInterface;
  ...
  whitelist: TypedContractMethod<[addr: AddressLike], [string], "nonpayable">;
