...
export interface Int32BareComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface Int32BareComponent extends BaseContract {
  connect(runner?: ContractRunner | null): Int32BareComponent;
  waitForDeployment(): Promise<this>;

  interface: Int32BareComponentInterface;
