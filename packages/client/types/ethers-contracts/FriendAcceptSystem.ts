...
export interface FriendAcceptSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FriendAcceptSystem extends BaseContract {
  connect(runner?: ContractRunner | null): FriendAcceptSystem;
  waitForDeployment(): Promise<this>;

  interface: FriendAcceptSystemInterface;
