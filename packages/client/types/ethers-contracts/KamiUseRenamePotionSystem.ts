...
export interface KamiUseRenamePotionSystemInterface extends utils.Interface {
  functions: {
...
export interface KamiUseRenamePotionSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KamiUseRenamePotionSystemInterface;
