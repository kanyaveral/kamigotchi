...
export interface CacheOperatorComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface CacheOperatorComponent extends BaseContract {
  connect(runner?: ContractRunner | null): CacheOperatorComponent;
  waitForDeployment(): Promise<this>;

  interface: CacheOperatorComponentInterface;
