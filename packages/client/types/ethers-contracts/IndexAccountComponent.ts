...
export interface IndexAccountComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexAccountComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexAccountComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexAccountComponentInterface;
