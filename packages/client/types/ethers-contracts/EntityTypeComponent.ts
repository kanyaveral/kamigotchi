...
export interface EntityTypeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface EntityTypeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): EntityTypeComponent;
  waitForDeployment(): Promise<this>;

  interface: EntityTypeComponentInterface;
