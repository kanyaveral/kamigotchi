...
export interface IDOwnsTaxComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsTaxComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsTaxComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsTaxComponentInterface;
