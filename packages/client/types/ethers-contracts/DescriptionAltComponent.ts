...
export interface DescriptionAltComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface DescriptionAltComponent extends BaseContract {
  connect(runner?: ContractRunner | null): DescriptionAltComponent;
  waitForDeployment(): Promise<this>;

  interface: DescriptionAltComponentInterface;
