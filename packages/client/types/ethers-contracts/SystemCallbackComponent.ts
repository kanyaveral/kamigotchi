...
export interface SystemCallbackComponentInterface extends utils.Interface {
  functions: {
    ...
    "getEntitiesWithValue((uint256,bytes))": FunctionFragment;
    ...
    "setBatch(uint256[],(uint256,bytes)[])": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getEntitiesWithValue((uint256,bytes))"
      | "getRaw"
      | "getRawBatch"
      | "getSchema"
      | "has"
      ...
      | "setBatch(uint256[],(uint256,bytes)[])"
      | "size"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint256,bytes))",
    values: [SystemCallbackStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setBatch(uint256[],(uint256,bytes)[])",
    values: [PromiseOrValue<BigNumberish>[], SystemCallbackStruct[]]
  ): string;
  encodeFunctionData(
...
export interface SystemCallbackComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemCallbackComponentInterface;
