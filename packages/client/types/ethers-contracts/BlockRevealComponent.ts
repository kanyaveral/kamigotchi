...
export interface BlockRevealComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface BlockRevealComponent extends BaseContract {
  connect(runner?: ContractRunner | null): BlockRevealComponent;
  waitForDeployment(): Promise<this>;

  interface: BlockRevealComponentInterface;
