...
export interface IndexBodyComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexBodyComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexBodyComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexBodyComponentInterface;
