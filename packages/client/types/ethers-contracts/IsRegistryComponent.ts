...
export interface IsRegistryComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IsRegistryComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IsRegistryComponent;
  waitForDeployment(): Promise<this>;

  interface: IsRegistryComponentInterface;
