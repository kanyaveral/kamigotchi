...
export interface SkillRespecSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SkillRespecSystem extends BaseContract {
  connect(runner?: ContractRunner | null): SkillRespecSystem;
  waitForDeployment(): Promise<this>;

  interface: SkillRespecSystemInterface;
  ...
  ): TypedContractMethod<[targetID: BigNumberish], [string], "nonpayable">;
  getFunction(
