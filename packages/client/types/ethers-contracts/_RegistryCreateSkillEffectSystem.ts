...
export interface _RegistryCreateSkillEffectSystemInterface
...
export interface _RegistryCreateSkillEffectSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _RegistryCreateSkillEffectSystemInterface;
