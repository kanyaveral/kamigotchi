...
export interface _TriggerCompEventSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _TriggerCompEventSystem extends BaseContract {
  connect(runner?: ContractRunner | null): _TriggerCompEventSystem;
  waitForDeployment(): Promise<this>;

  interface: _TriggerCompEventSystemInterface;
