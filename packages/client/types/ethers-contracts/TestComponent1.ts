...
export interface TestComponent1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ID"
      | "authorizeWriter"
...
export interface TestComponent1 extends BaseContract {
  connect(runner?: ContractRunner | null): TestComponent1;
  waitForDeployment(): Promise<this>;

  interface: TestComponent1Interface;
