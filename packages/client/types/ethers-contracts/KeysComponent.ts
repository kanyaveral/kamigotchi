...
export interface KeysComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface KeysComponent extends BaseContract {
  connect(runner?: ContractRunner | null): KeysComponent;
  waitForDeployment(): Promise<this>;

  interface: KeysComponentInterface;
