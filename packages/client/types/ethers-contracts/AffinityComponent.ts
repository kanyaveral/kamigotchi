...
export interface AffinityComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface AffinityComponent extends BaseContract {
  connect(runner?: ContractRunner | null): AffinityComponent;
  waitForDeployment(): Promise<this>;

  interface: AffinityComponentInterface;
