...
export interface KamiCastItemSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiCastItemSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiCastItemSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiCastItemSystemInterface;
