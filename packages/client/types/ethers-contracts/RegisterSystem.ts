...
export interface RegisterSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface RegisterSystem extends BaseContract {
  connect(runner?: ContractRunner | null): RegisterSystem;
  ...
  "execute(bytes)": TypedContractMethod<
    [args: BytesLike],
    [string],
    "nonpayable"
  >;

  "execute(address,uint8,address,uint256)": TypedContractMethod<
    [
  ...
  getFunction(
    nameOrSignature: "execute(bytes)"
  ): TypedContractMethod<[args: BytesLike], [string], "nonpayable">;
  getFunction(
    nameOrSignature: "execute(address,uint8,address,uint256)"
  ): TypedContractMethod<
    [
      msgSender: AddressLike,
      registerType: BigNumberish,
