...
export interface IsConditionComponentInterface extends utils.Interface {
  functions: {
...
export interface IsConditionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsConditionComponentInterface;
