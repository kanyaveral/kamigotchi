...
export interface IsBonusComponentInterface extends utils.Interface {
  functions: {
...
export interface IsBonusComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsBonusComponentInterface;
