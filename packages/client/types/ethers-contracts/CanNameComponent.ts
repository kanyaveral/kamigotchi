...
export interface CanNameComponentInterface extends utils.Interface {
  functions: {
...
export interface CanNameComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CanNameComponentInterface;
