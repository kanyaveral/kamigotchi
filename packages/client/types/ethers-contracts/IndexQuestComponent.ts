...
export interface IndexQuestComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexQuestComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexQuestComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexQuestComponentInterface;
