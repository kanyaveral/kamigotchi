...
export interface IndexRelationshipComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexRelationshipComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexRelationshipComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexRelationshipComponentInterface;
