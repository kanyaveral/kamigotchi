...
export interface StringArrayBareComponentInterface extends utils.Interface {
  functions: {
    ...
    "setBatch(uint256[],string[][])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setBatch(uint256[],string[][])",
    values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<string>[][]]
  ): string;
  encodeFunctionData(
...
export interface StringArrayBareComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StringArrayBareComponentInterface;
