...
export interface BlacklistComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface BlacklistComponent extends BaseContract {
  connect(runner?: ContractRunner | null): BlacklistComponent;
  waitForDeployment(): Promise<this>;

  interface: BlacklistComponentInterface;
