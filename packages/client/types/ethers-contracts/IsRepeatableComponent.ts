...
export interface IsRepeatableComponentInterface extends utils.Interface {
  functions: {
...
export interface IsRepeatableComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsRepeatableComponentInterface;
