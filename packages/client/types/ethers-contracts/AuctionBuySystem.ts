...
export interface AuctionBuySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AuctionBuySystem extends BaseContract {
  connect(runner?: ContractRunner | null): AuctionBuySystem;
  waitForDeployment(): Promise<this>;

  interface: AuctionBuySystemInterface;
  ...
  executeTyped: TypedContractMethod<
    [itemIndex: BigNumberish, amt: BigNumberish],
    [string],
    "nonpayable"
  >;
