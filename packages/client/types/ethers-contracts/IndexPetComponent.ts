...
export interface IndexPetComponentInterface extends utils.Interface {
  functions: {
...
export interface IndexPetComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IndexPetComponentInterface;
