...
export interface PetUseTransferrerSystemInterface extends utils.Interface {
  functions: {
...
export interface PetUseTransferrerSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PetUseTransferrerSystemInterface;
