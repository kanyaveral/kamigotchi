...
export interface Uint32ArrayComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface Uint32ArrayComponent extends BaseContract {
  connect(runner?: ContractRunner | null): Uint32ArrayComponent;
  waitForDeployment(): Promise<this>;

  interface: Uint32ArrayComponentInterface;
