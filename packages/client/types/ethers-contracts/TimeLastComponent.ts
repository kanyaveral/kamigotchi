...
export interface TimeLastComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface TimeLastComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TimeLastComponent;
  waitForDeployment(): Promise<this>;

  interface: TimeLastComponentInterface;
