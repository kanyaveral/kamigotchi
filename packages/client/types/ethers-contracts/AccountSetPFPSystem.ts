...
export interface AccountSetPFPSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AccountSetPFPSystem extends BaseContract {
  connect(runner?: ContractRunner | null): AccountSetPFPSystem;
  waitForDeployment(): Promise<this>;

  interface: AccountSetPFPSystemInterface;
  ...
  ): TypedContractMethod<[kamiID: BigNumberish], [string], "nonpayable">;
  getFunction(
