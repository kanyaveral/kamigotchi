...
export interface RelationshipAdvanceSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface RelationshipAdvanceSystem extends BaseContract {
  connect(runner?: ContractRunner | null): RelationshipAdvanceSystem;
  waitForDeployment(): Promise<this>;

  interface: RelationshipAdvanceSystemInterface;
