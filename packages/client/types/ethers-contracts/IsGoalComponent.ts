...
export interface IsGoalComponentInterface extends utils.Interface {
  functions: {
...
export interface IsGoalComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsGoalComponentInterface;
