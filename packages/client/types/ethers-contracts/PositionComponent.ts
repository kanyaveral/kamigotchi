...
export interface PositionComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface PositionComponent extends BaseContract {
  connect(runner?: ContractRunner | null): PositionComponent;
  ...
  "getEntitiesWithValue((int64,int64))": TypedContractMethod<
  ...
  "set(uint256,(int64,int64))": TypedContractMethod<
    [entity: BigNumberish, value: PositionStruct],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getEntitiesWithValue((int64,int64))"
  ): TypedContractMethod<[value: PositionStruct], [bigint[]], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "set(uint256,(int64,int64))"
  ): TypedContractMethod<
    [entity: BigNumberish, value: PositionStruct],
    [void],
    "nonpayable"
