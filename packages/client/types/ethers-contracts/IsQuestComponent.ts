...
export interface IsQuestComponentInterface extends utils.Interface {
  functions: {
...
export interface IsQuestComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsQuestComponentInterface;
