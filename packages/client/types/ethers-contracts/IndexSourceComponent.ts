...
export interface IndexSourceComponentInterface extends utils.Interface {
  functions: {
...
export interface IndexSourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IndexSourceComponentInterface;
