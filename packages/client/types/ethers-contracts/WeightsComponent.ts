...
export interface WeightsComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface WeightsComponent extends BaseContract {
  connect(runner?: ContractRunner | null): WeightsComponent;
  waitForDeployment(): Promise<this>;

  interface: WeightsComponentInterface;
