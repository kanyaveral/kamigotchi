...
export interface IndexRecipeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexRecipeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexRecipeComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexRecipeComponentInterface;
