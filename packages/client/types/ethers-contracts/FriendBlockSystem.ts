...
export interface FriendBlockSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FriendBlockSystem extends BaseContract {
  connect(runner?: ContractRunner | null): FriendBlockSystem;
  waitForDeployment(): Promise<this>;

  interface: FriendBlockSystemInterface;
