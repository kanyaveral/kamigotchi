...
export interface IsRegisterComponentInterface extends utils.Interface {
  functions: {
...
export interface IsRegisterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsRegisterComponentInterface;
