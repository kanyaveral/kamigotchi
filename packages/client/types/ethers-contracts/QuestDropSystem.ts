...
export interface QuestDropSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuestDropSystem extends BaseContract {
  connect(runner?: ContractRunner | null): QuestDropSystem;
  waitForDeployment(): Promise<this>;

  interface: QuestDropSystemInterface;
