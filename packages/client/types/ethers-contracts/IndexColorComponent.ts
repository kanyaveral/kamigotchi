...
export interface IndexColorComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexColorComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexColorComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexColorComponentInterface;
