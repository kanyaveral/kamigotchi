...
export interface IsRequirementComponentInterface extends utils.Interface {
  functions: {
...
export interface IsRequirementComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsRequirementComponentInterface;
