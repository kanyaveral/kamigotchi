...
export interface FriendRequestSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FriendRequestSystem extends BaseContract {
  connect(runner?: ContractRunner | null): FriendRequestSystem;
  waitForDeployment(): Promise<this>;

  interface: FriendRequestSystemInterface;
  ...
  ): TypedContractMethod<[targetAddr: AddressLike], [string], "nonpayable">;
  getFunction(
