...
export interface SkillPointComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface SkillPointComponent extends BaseContract {
  connect(runner?: ContractRunner | null): SkillPointComponent;
  waitForDeployment(): Promise<this>;

  interface: SkillPointComponentInterface;
