...
export interface TokenHolderComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "adminFreeze"
      | "authorizeWriter"
...
export interface TokenHolderComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TokenHolderComponent;
  waitForDeployment(): Promise<this>;

  interface: TokenHolderComponentInterface;
  ...
  escapeHatch: TypedContractMethod<[token: AddressLike], [void], "nonpayable">;
