...
export interface TestComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ID"
      | "authorizeWriter"
...
export interface TestComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TestComponent;
