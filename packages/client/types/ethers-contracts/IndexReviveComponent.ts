...
export interface IndexReviveComponentInterface extends utils.Interface {
  functions: {
...
export interface IndexReviveComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IndexReviveComponentInterface;
