...
export interface QuestAcceptSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuestAcceptSystem extends BaseContract {
  connect(runner?: ContractRunner | null): QuestAcceptSystem;
  waitForDeployment(): Promise<this>;

  interface: QuestAcceptSystemInterface;
