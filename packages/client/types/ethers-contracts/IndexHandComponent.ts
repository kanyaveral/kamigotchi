...
export interface IndexHandComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexHandComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexHandComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexHandComponentInterface;
