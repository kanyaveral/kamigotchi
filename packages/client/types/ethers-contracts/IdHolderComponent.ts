...
export interface IdHolderComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IdHolderComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IdHolderComponent;
  waitForDeployment(): Promise<this>;

  interface: IdHolderComponentInterface;
