...
export interface TimeNextComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface TimeNextComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TimeNextComponent;
  waitForDeployment(): Promise<this>;

  interface: TimeNextComponentInterface;
