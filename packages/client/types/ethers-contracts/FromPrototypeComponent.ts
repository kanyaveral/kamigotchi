...
export interface FromPrototypeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ID"
      | "authorizeWriter"
...
export interface FromPrototypeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): FromPrototypeComponent;
  ...
  "set(uint256,uint256)": TypedContractMethod<
    [entity: BigNumberish, prototypeEntity: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[prototypeEntity: BigNumberish], [bigint[]], "view">;
  getFunction(
