...
export interface DamageComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface DamageComponent extends BaseContract {
  connect(runner?: ContractRunner | null): DamageComponent;
  waitForDeployment(): Promise<this>;

  interface: DamageComponentInterface;
