...
export interface IndexCurrencyComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexCurrencyComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexCurrencyComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexCurrencyComponentInterface;
