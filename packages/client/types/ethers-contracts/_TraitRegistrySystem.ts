...
export interface _TraitRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _TraitRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _TraitRegistrySystem;
  waitForDeployment(): Promise<this>;

  interface: _TraitRegistrySystemInterface;
  ...
  remove: TypedContractMethod<
    [index: BigNumberish, traitType: string],
    [void],
    "nonpayable"
  >;
