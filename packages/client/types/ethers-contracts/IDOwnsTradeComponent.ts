...
export interface IDOwnsTradeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsTradeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsTradeComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsTradeComponentInterface;
