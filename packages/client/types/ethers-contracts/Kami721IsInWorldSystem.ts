...
export interface Kami721IsInWorldSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface Kami721IsInWorldSystem extends BaseContract {
  connect(runner?: ContractRunner | null): Kami721IsInWorldSystem;
  waitForDeployment(): Promise<this>;

  interface: Kami721IsInWorldSystemInterface;
  ...
  executeTyped: TypedContractMethod<[], [string], "nonpayable">;

  isInWorld: TypedContractMethod<[petIndex: BigNumberish], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "isInWorld"
  ): TypedContractMethod<[petIndex: BigNumberish], [boolean], "view">;
  getFunction(
