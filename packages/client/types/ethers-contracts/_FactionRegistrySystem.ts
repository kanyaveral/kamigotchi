...
export interface _FactionRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _FactionRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _FactionRegistrySystem;
  waitForDeployment(): Promise<this>;

  interface: _FactionRegistrySystemInterface;
