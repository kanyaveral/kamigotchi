...
export interface Int32ComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface Int32Component extends BaseContract {
  connect(runner?: ContractRunner | null): Int32Component;
  ...
  "dec(uint256[],int32[])": TypedContractMethod<
  ...
  "getEntitiesWithValue(int32)": TypedContractMethod<
    [value: BigNumberish],
    [bigint[]],
    "view"
  >;
  ...
  "inc(uint256,int32)": TypedContractMethod<
    [entity: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  "set(uint256[],int32[])": TypedContractMethod<
    [entities: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "dec(uint256[],int32[])"
  ): TypedContractMethod<
    [entities: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "getEntitiesWithValue(int32)"
  ...
  getFunction(
    nameOrSignature: "inc(uint256,int32)"
  ): TypedContractMethod<
    [entity: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "set(uint256[],int32[])"
  ): TypedContractMethod<
    [entities: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
