...
export interface DecayComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface DecayComponent extends BaseContract {
  connect(runner?: ContractRunner | null): DecayComponent;
  waitForDeployment(): Promise<this>;

  interface: DecayComponentInterface;
