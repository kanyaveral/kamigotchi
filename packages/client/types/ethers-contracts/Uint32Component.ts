...
export interface Uint32ComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
  ...
  encodeFunctionData(
    functionFragment: "dec(uint256,uint32)",
  ...
  encodeFunctionData(
    functionFragment: "inc(uint256[],uint32[])",
    values: [BigNumberish[], BigNumberish[]]
  ): string;
  encodeFunctionData(
    functionFragment: "inc(uint256[],uint32)",
...
export interface Uint32Component extends BaseContract {
  connect(runner?: ContractRunner | null): Uint32Component;
  ...
  "dec(uint256,uint32)": TypedContractMethod<
  ...
  "getEntitiesWithValue(uint32)": TypedContractMethod<
    [value: BigNumberish],
    [bigint[]],
    "view"
  >;
  ...
  "inc(uint256[],uint32[])": TypedContractMethod<
    [entities: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  "set(uint256[],uint32[])": TypedContractMethod<
    [entities: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "dec(uint256,uint32)"
  ): TypedContractMethod<
    [entity: BigNumberish, value: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "getEntitiesWithValue(uint32)"
  ...
  getFunction(
    nameOrSignature: "inc(uint256[],uint32[])"
  ): TypedContractMethod<
    [entities: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "set(uint256[],uint32[])"
  ): TypedContractMethod<
    [entities: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
