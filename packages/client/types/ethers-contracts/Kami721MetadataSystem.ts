...
export interface Kami721MetadataSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface Kami721MetadataSystem extends BaseContract {
  connect(runner?: ContractRunner | null): Kami721MetadataSystem;
  waitForDeployment(): Promise<this>;

  interface: Kami721MetadataSystemInterface;
  ...
  tokenURI: TypedContractMethod<[petIndex: BigNumberish], [string], "view">;
  ...
  ): TypedContractMethod<[petIndex: BigNumberish], [string], "view">;
  getFunction(
