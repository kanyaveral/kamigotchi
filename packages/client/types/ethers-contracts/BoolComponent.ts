...
export interface BoolComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface BoolComponent extends BaseContract {
  connect(runner?: ContractRunner | null): BoolComponent;
  ...
  "set(uint256)": TypedContractMethod<
    [entity: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[entities: BigNumberish[]], [boolean[]], "nonpayable">;
  getFunction(
    nameOrSignature: "extract(uint256)"
  ): TypedContractMethod<[entity: BigNumberish], [boolean], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[entities: BigNumberish[]], [boolean[]], "view">;
  getFunction(
    nameOrSignature: "get(uint256)"
