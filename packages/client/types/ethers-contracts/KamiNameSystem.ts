...
export interface KamiNameSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiNameSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiNameSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiNameSystemInterface;
