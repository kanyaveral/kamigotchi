...
export interface IndexFactionComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexFactionComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexFactionComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexFactionComponentInterface;
