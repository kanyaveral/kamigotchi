...
export interface IdSourceComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IdSourceComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IdSourceComponent;
  waitForDeployment(): Promise<this>;

  interface: IdSourceComponentInterface;
