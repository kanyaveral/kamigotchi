...
export interface TokenAllowanceComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "adminFreeze"
      | "authorizeWriter"
...
export interface TokenAllowanceComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TokenAllowanceComponent;
  waitForDeployment(): Promise<this>;

  interface: TokenAllowanceComponentInterface;
