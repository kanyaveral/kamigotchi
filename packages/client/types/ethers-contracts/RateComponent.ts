...
export interface RateComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface RateComponent extends BaseContract {
  connect(runner?: ContractRunner | null): RateComponent;
  waitForDeployment(): Promise<this>;

  interface: RateComponentInterface;
