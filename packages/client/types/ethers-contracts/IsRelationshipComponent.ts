...
export interface IsRelationshipComponentInterface extends utils.Interface {
  functions: {
...
export interface IsRelationshipComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsRelationshipComponentInterface;
