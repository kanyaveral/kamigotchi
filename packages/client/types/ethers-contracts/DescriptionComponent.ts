...
export interface DescriptionComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface DescriptionComponent extends BaseContract {
  connect(runner?: ContractRunner | null): DescriptionComponent;
