...
export interface PrototypeComponentInterface extends utils.Interface {
  functions: {
...
export interface PrototypeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrototypeComponentInterface;
