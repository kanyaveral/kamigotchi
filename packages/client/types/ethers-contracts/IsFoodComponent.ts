...
export interface IsFoodComponentInterface extends utils.Interface {
  functions: {
...
export interface IsFoodComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsFoodComponentInterface;
