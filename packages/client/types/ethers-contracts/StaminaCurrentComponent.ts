...
export interface StaminaCurrentComponentInterface extends utils.Interface {
  functions: {
...
export interface StaminaCurrentComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StaminaCurrentComponentInterface;
