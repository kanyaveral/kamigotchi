...
export interface SubtypeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface SubtypeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): SubtypeComponent;
  waitForDeployment(): Promise<this>;

  interface: SubtypeComponentInterface;
