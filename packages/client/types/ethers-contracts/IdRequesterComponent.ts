...
export interface IdRequesterComponentInterface extends utils.Interface {
  functions: {
...
export interface IdRequesterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IdRequesterComponentInterface;
