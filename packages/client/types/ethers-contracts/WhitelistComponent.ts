...
export interface WhitelistComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface WhitelistComponent extends BaseContract {
  connect(runner?: ContractRunner | null): WhitelistComponent;
  waitForDeployment(): Promise<this>;

  interface: WhitelistComponentInterface;
