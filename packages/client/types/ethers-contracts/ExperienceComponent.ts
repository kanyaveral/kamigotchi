...
export interface ExperienceComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface ExperienceComponent extends BaseContract {
  connect(runner?: ContractRunner | null): ExperienceComponent;
