...
export interface _QuestRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addObjective"
      | "addRequirement"
...
export interface _QuestRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _QuestRegistrySystem;
  ...
  addObjective: TypedContractMethod<
    [arguments: BytesLike],
    [bigint],
    "nonpayable"
  >;
