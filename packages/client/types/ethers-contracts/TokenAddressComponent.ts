...
export interface TokenAddressComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface TokenAddressComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TokenAddressComponent;
  waitForDeployment(): Promise<this>;

  interface: TokenAddressComponentInterface;
