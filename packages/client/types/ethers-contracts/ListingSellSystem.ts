...
export interface ListingSellSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ListingSellSystem extends BaseContract {
  connect(runner?: ContractRunner | null): ListingSellSystem;
  ...
  executeTyped: TypedContractMethod<
    [
      merchantIndex: BigNumberish,
      itemIndices: BigNumberish[],
      amts: BigNumberish[]
    ],
    [string],
    "nonpayable"
