...
export interface KamiOnyxReviveSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiOnyxReviveSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiOnyxReviveSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiOnyxReviveSystemInterface;
