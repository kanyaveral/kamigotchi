...
export interface ItemTransferSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ItemTransferSystem extends BaseContract {
  connect(runner?: ContractRunner | null): ItemTransferSystem;
  waitForDeployment(): Promise<this>;

  interface: ItemTransferSystemInterface;
  ...
  executeTyped: TypedContractMethod<
    [indices: BigNumberish[], amts: BigNumberish[], targetID: BigNumberish],
    [string],
    "nonpayable"
  >;
