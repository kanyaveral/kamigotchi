...
export interface IDOwnsWithdrawalComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsWithdrawalComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsWithdrawalComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsWithdrawalComponentInterface;
