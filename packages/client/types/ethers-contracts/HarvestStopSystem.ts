...
export interface HarvestStopSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "executeAllowFailure",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "executeBatchedAllowFailure",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
...
export interface HarvestStopSystem extends BaseContract {
  connect(runner?: ContractRunner | null): HarvestStopSystem;
  waitForDeployment(): Promise<this>;

  interface: HarvestStopSystemInterface;
  ...
  executeAllowFailure: TypedContractMethod<
    [arguments: BytesLike],
    [string],
    "nonpayable"
  >;

  executeBatched: TypedContractMethod<
    [ids: BigNumberish[]],
    [string[]],
    "nonpayable"
  >;

  executeBatchedAllowFailure: TypedContractMethod<
    [ids: BigNumberish[]],
    [string[]],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "executeAllowFailure"
  ): TypedContractMethod<[arguments: BytesLike], [string], "nonpayable">;
  getFunction(
    nameOrSignature: "executeBatched"
  ): TypedContractMethod<[ids: BigNumberish[]], [string[]], "nonpayable">;
  getFunction(
    nameOrSignature: "executeBatchedAllowFailure"
  ): TypedContractMethod<[ids: BigNumberish[]], [string[]], "nonpayable">;
  getFunction(
