...
export interface ViolenceComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
      | "boost"
...
export interface ViolenceComponent extends BaseContract {
  connect(runner?: ContractRunner | null): ViolenceComponent;
  waitForDeployment(): Promise<this>;

  interface: ViolenceComponentInterface;
