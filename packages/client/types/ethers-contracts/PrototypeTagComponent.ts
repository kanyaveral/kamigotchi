...
export interface PrototypeTagComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ID"
      | "authorizeWriter"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,bool)",
...
export interface PrototypeTagComponent extends BaseContract {
  connect(runner?: ContractRunner | null): PrototypeTagComponent;
  waitForDeployment(): Promise<this>;

  interface: PrototypeTagComponentInterface;
  ...
  "getEntitiesWithValue(bool)": TypedContractMethod<
    [value: boolean],
    [bigint[]],
    "view"
  >;
  ...
  getValue: TypedContractMethod<[entity: BigNumberish], [boolean], "view">;
  ...
  "set(uint256,bool)": TypedContractMethod<
    [entity: BigNumberish, value: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getEntitiesWithValue(bool)"
  ): TypedContractMethod<[value: boolean], [bigint[]], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "set(uint256,bool)"
  ): TypedContractMethod<
    [entity: BigNumberish, value: boolean],
    [void],
    "nonpayable"
