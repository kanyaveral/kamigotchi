...
export interface ProxyVIPScoreComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "adminFreeze"
      | "authorizeWriter"
...
export interface ProxyVIPScoreComponent extends BaseContract {
  connect(runner?: ContractRunner | null): ProxyVIPScoreComponent;
  ...
  adminFreeze: TypedContractMethod<[], [boolean], "view">;
  ...
  finalizeStage: TypedContractMethod<
    [scorer: AddressLike, stage: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  setAdminFreeze: TypedContractMethod<
    [_adminFreeze: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setAdminFreeze"
  ): TypedContractMethod<[_adminFreeze: boolean], [void], "nonpayable">;
  getFunction(
