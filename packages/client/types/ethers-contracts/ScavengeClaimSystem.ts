...
export interface ScavengeClaimSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ScavengeClaimSystem extends BaseContract {
  connect(runner?: ContractRunner | null): ScavengeClaimSystem;
  waitForDeployment(): Promise<this>;

  interface: ScavengeClaimSystemInterface;
