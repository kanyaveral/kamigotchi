...
export interface ValuesComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface ValuesComponent extends BaseContract {
  connect(runner?: ContractRunner | null): ValuesComponent;
  waitForDeployment(): Promise<this>;

  interface: ValuesComponentInterface;
