...
export interface _721BatchMinterSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_getTraitStats"
      | "batchMint"
...
export interface _721BatchMinterSystem extends BaseContract {
  connect(runner?: ContractRunner | null): _721BatchMinterSystem;
  ...
  setTraits: TypedContractMethod<[], [void], "nonpayable">;
