...
export interface KamiUseFoodSystemInterface extends utils.Interface {
  functions: {
...
export interface KamiUseFoodSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KamiUseFoodSystemInterface;
