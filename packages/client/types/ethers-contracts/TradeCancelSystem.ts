...
export interface TradeCancelSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TradeCancelSystem extends BaseContract {
  connect(runner?: ContractRunner | null): TradeCancelSystem;
  waitForDeployment(): Promise<this>;

  interface: TradeCancelSystemInterface;
