...
export interface RarityComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface RarityComponent extends BaseContract {
  connect(runner?: ContractRunner | null): RarityComponent;
  waitForDeployment(): Promise<this>;

  interface: RarityComponentInterface;
