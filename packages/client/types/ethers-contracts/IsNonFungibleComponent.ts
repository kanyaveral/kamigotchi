...
export interface IsNonFungibleComponentInterface extends utils.Interface {
  functions: {
...
export interface IsNonFungibleComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsNonFungibleComponentInterface;
