...
export interface IsCompleteComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IsCompleteComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IsCompleteComponent;
  waitForDeployment(): Promise<this>;

  interface: IsCompleteComponentInterface;
