...
export interface IsDataComponentInterface extends utils.Interface {
  functions: {
...
export interface IsDataComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsDataComponentInterface;
