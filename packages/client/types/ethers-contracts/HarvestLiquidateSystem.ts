...
export interface HarvestLiquidateSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface HarvestLiquidateSystem extends BaseContract {
  connect(runner?: ContractRunner | null): HarvestLiquidateSystem;
  waitForDeployment(): Promise<this>;

  interface: HarvestLiquidateSystemInterface;
  ...
  executeTyped: TypedContractMethod<
    [victimHarvID: BigNumberish, killerID: BigNumberish],
    [string],
    "nonpayable"
  >;
