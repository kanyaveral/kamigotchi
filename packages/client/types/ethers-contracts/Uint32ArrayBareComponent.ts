...
export interface Uint32ArrayBareComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface Uint32ArrayBareComponent extends BaseContract {
  connect(runner?: ContractRunner | null): Uint32ArrayBareComponent;
  waitForDeployment(): Promise<this>;

  interface: Uint32ArrayBareComponentInterface;
