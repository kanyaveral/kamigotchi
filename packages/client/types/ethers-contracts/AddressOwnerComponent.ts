...
export interface AddressOwnerComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface AddressOwnerComponent extends BaseContract {
  connect(runner?: ContractRunner | null): AddressOwnerComponent;
  waitForDeployment(): Promise<this>;

  interface: AddressOwnerComponentInterface;
