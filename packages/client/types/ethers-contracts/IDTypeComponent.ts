...
export interface IDTypeComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDTypeComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDTypeComponent;
  waitForDeployment(): Promise<this>;

  interface: IDTypeComponentInterface;
