...
export interface KamiGachaMintSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiGachaMintSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiGachaMintSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiGachaMintSystemInterface;
