...
export interface FriendCancelSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FriendCancelSystem extends BaseContract {
  connect(runner?: ContractRunner | null): FriendCancelSystem;
  waitForDeployment(): Promise<this>;

  interface: FriendCancelSystemInterface;
