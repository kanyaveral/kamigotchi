...
export interface IsSkillComponentInterface extends utils.Interface {
  functions: {
...
export interface IsSkillComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsSkillComponentInterface;
