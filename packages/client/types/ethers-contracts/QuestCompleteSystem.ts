...
export interface QuestCompleteSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuestCompleteSystem extends BaseContract {
  connect(runner?: ContractRunner | null): QuestCompleteSystem;
  waitForDeployment(): Promise<this>;

  interface: QuestCompleteSystemInterface;
