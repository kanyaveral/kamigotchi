...
export interface StaminaComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
      | "boost"
...
export interface StaminaComponent extends BaseContract {
  connect(runner?: ContractRunner | null): StaminaComponent;
  waitForDeployment(): Promise<this>;

  interface: StaminaComponentInterface;
