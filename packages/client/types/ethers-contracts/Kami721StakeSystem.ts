...
export interface Kami721StakeSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface Kami721StakeSystem extends BaseContract {
  connect(runner?: ContractRunner | null): Kami721StakeSystem;
  waitForDeployment(): Promise<this>;

  interface: Kami721StakeSystemInterface;
