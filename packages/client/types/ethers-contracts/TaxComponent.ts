...
export interface TaxComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface TaxComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TaxComponent;
  waitForDeployment(): Promise<this>;

  interface: TaxComponentInterface;
