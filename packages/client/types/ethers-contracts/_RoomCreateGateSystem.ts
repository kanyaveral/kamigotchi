...
export interface _RoomCreateGateSystemInterface extends utils.Interface {
  functions: {
    ...
    "executeTyped(uint256,uint256,uint256,uint256,string,string)": FunctionFragment;
...
export interface _RoomCreateGateSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _RoomCreateGateSystemInterface;
