...
export interface EchoRoomSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface EchoRoomSystem extends BaseContract {
  connect(runner?: ContractRunner | null): EchoRoomSystem;
  waitForDeployment(): Promise<this>;

  interface: EchoRoomSystemInterface;
