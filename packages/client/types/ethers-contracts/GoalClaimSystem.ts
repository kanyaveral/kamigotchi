...
export interface GoalClaimSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface GoalClaimSystem extends BaseContract {
  connect(runner?: ContractRunner | null): GoalClaimSystem;
  waitForDeployment(): Promise<this>;

  interface: GoalClaimSystemInterface;
  ...
  ): TypedContractMethod<[goalIndex: BigNumberish], [string], "nonpayable">;
  getFunction(
