...
export interface IsRegistryEntryComponentInterface extends utils.Interface {
  functions: {
...
export interface IsRegistryEntryComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsRegistryEntryComponentInterface;
