...
export interface GoalContributeSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface GoalContributeSystem extends BaseContract {
  connect(runner?: ContractRunner | null): GoalContributeSystem;
  waitForDeployment(): Promise<this>;

  interface: GoalContributeSystemInterface;
  ...
  executeTyped: TypedContractMethod<
    [goalIndex: BigNumberish, amt: BigNumberish],
    [string],
    "nonpayable"
  >;
