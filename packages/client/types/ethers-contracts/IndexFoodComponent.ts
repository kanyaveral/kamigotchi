...
export interface IndexFoodComponentInterface extends utils.Interface {
  functions: {
...
export interface IndexFoodComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IndexFoodComponentInterface;
