...
export interface IsLootboxComponentInterface extends utils.Interface {
  functions: {
...
export interface IsLootboxComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsLootboxComponentInterface;
