...
export interface TimeEndComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface TimeEndComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TimeEndComponent;
  waitForDeployment(): Promise<this>;

  interface: TimeEndComponentInterface;
