...
export interface Kami721TransferSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "batchTransfer"
      | "batchTransferToMany"
...
export interface Kami721TransferSystem extends BaseContract {
  connect(runner?: ContractRunner | null): Kami721TransferSystem;
  waitForDeployment(): Promise<this>;

  interface: Kami721TransferSystemInterface;
  ...
  batchTransfer: TypedContractMethod<
    [tokenIndices: BigNumberish[], to: AddressLike],
    [void],
    "nonpayable"
  >;

  batchTransferToMany: TypedContractMethod<
    [tokenIndices: BigNumberish[], to: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "batchTransferToMany"
  ): TypedContractMethod<
    [tokenIndices: BigNumberish[], to: AddressLike[]],
    [void],
    "nonpayable"
