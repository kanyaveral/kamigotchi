...
export interface IndexFaceComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexFaceComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexFaceComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexFaceComponentInterface;
