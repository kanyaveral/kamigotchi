...
export interface IsEquippedComponentInterface extends utils.Interface {
  functions: {
...
export interface IsEquippedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsEquippedComponentInterface;
