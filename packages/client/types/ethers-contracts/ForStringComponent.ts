...
export interface ForStringComponentInterface extends utils.Interface {
  functions: {
...
export interface ForStringComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ForStringComponentInterface;
