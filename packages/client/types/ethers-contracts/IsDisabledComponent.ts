...
export interface IsDisabledComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IsDisabledComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IsDisabledComponent;
  waitForDeployment(): Promise<this>;

  interface: IsDisabledComponentInterface;
