...
export interface ChatSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addRequirement"
...
export interface ChatSystem extends BaseContract {
  connect(runner?: ContractRunner | null): ChatSystem;
  ...
  executeTyped: TypedContractMethod<[message: string], [string], "nonpayable">;
  ...
  removeRequirement: TypedContractMethod<[], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[message: string], [string], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "removeRequirement"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
