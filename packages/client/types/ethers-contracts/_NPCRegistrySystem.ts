...
export interface _NPCRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface _NPCRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _NPCRegistrySystem;
  ...
  setRoom: TypedContractMethod<
    [index: BigNumberish, roomIndex: BigNumberish],
    [void],
    "nonpayable"
  >;
