...
export interface IndexRoomComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexRoomComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexRoomComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexRoomComponentInterface;
