...
export interface AccountMoveSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AccountMoveSystem extends BaseContract {
  connect(runner?: ContractRunner | null): AccountMoveSystem;
  waitForDeployment(): Promise<this>;

  interface: AccountMoveSystemInterface;
  ...
  ): TypedContractMethod<[toIndex: BigNumberish], [string], "nonpayable">;
  getFunction(
