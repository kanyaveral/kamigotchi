...
export interface AddressOperatorComponentInterface extends utils.Interface {
  functions: {
    ...
    "setBatch(uint256[],address[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setBatch(uint256[],address[])",
    values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
