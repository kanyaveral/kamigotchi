...
export interface AddressOperatorComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface AddressOperatorComponent extends BaseContract {
  connect(runner?: ContractRunner | null): AddressOperatorComponent;
  waitForDeployment(): Promise<this>;

  interface: AddressOperatorComponentInterface;
  ...
  "get(uint256)": TypedContractMethod<[entity: BigNumberish], [string], "view">;
  ...
  "getEntitiesWithValue(address)": TypedContractMethod<
    [value: AddressLike],
    [bigint[]],
    "view"
  >;
  ...
  "set(uint256,address)": TypedContractMethod<
    [entity: BigNumberish, value: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  "set(uint256[],address[])": TypedContractMethod<
    [entities: BigNumberish[], values: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getEntitiesWithValue(address)"
