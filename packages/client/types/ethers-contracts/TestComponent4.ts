...
export interface TestComponent4Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ID"
      | "authorizeWriter"
...
export interface TestComponent4 extends BaseContract {
  connect(runner?: ContractRunner | null): TestComponent4;
  waitForDeployment(): Promise<this>;

  interface: TestComponent4Interface;
