...
export interface DroptableRevealSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface DroptableRevealSystem extends BaseContract {
  connect(runner?: ContractRunner | null): DroptableRevealSystem;
  ...
  forceReveal: TypedContractMethod<[id: BigNumberish], [void], "nonpayable">;
