...
export interface TestComponent3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ID"
      | "authorizeWriter"
...
export interface TestComponent3 extends BaseContract {
  connect(runner?: ContractRunner | null): TestComponent3;
  waitForDeployment(): Promise<this>;

  interface: TestComponent3Interface;
