...
export interface HarmonyComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
      | "boost"
...
export interface HarmonyComponent extends BaseContract {
  connect(runner?: ContractRunner | null): HarmonyComponent;
  waitForDeployment(): Promise<this>;

  interface: HarmonyComponentInterface;
