...
export interface IndexBackgroundComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexBackgroundComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexBackgroundComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexBackgroundComponentInterface;
