...
export interface TimeResetComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface TimeResetComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TimeResetComponent;
  waitForDeployment(): Promise<this>;

  interface: TimeResetComponentInterface;
