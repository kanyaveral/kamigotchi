...
export interface ForComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface ForComponent extends BaseContract {
  connect(runner?: ContractRunner | null): ForComponent;
  waitForDeployment(): Promise<this>;

  interface: ForComponentInterface;
