...
export interface IDFromComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDFromComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDFromComponent;
  waitForDeployment(): Promise<this>;

  interface: IDFromComponentInterface;
