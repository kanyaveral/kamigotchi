...
export interface SkillUpgradeSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SkillUpgradeSystem extends BaseContract {
  connect(runner?: ContractRunner | null): SkillUpgradeSystem;
  waitForDeployment(): Promise<this>;

  interface: SkillUpgradeSystemInterface;
  ...
  executeTyped: TypedContractMethod<
    [holderID: BigNumberish, skillIndex: BigNumberish],
    [string],
    "nonpayable"
  >;
