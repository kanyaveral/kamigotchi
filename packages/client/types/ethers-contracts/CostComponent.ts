...
export interface CostComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface CostComponent extends BaseContract {
  connect(runner?: ContractRunner | null): CostComponent;
  waitForDeployment(): Promise<this>;

  interface: CostComponentInterface;
