...
export interface PetUseReviveSystemInterface extends utils.Interface {
  functions: {
...
export interface PetUseReviveSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PetUseReviveSystemInterface;
