...
export interface IsFriendshipComponentInterface extends utils.Interface {
  functions: {
...
export interface IsFriendshipComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsFriendshipComponentInterface;
