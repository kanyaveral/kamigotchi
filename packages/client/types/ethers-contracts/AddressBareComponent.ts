...
export interface AddressBareComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface AddressBareComponent extends BaseContract {
  connect(runner?: ContractRunner | null): AddressBareComponent;
  waitForDeployment(): Promise<this>;

  interface: AddressBareComponentInterface;
