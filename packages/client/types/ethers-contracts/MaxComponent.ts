...
export interface MaxComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface MaxComponent extends BaseContract {
  connect(runner?: ContractRunner | null): MaxComponent;
  waitForDeployment(): Promise<this>;

  interface: MaxComponentInterface;
