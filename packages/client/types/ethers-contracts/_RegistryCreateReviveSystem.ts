...
export interface _RegistryCreateReviveSystemInterface extends utils.Interface {
  functions: {
    ...
    "executeTyped(uint256,uint256,string,uint256)": FunctionFragment;
...
export interface _RegistryCreateReviveSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _RegistryCreateReviveSystemInterface;
