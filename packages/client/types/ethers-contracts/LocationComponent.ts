...
export type CoordStruct = { x: BigNumberish; y: BigNumberish; z: BigNumberish };

export type CoordStructOutput = [x: bigint, y: bigint, z: bigint] & {
  x: bigint;
  y: bigint;
  z: bigint;
};

export interface LocationComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface LocationComponent extends BaseContract {
  connect(runner?: ContractRunner | null): LocationComponent;
  ...
  "getEntitiesWithValue((int32,int32,int32))": TypedContractMethod<
    [value: CoordStruct],
    [bigint[]],
    "view"
  >;
  ...
  "set(uint256,(int32,int32,int32))": TypedContractMethod<
    [entity: BigNumberish, value: CoordStruct],
    [void],
    "nonpayable"
  >;

  "set(uint256[],(int32,int32,int32)[])": TypedContractMethod<
    [entities: BigNumberish[], values: CoordStruct[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "get(uint256)"
  ): TypedContractMethod<[entity: BigNumberish], [CoordStructOutput], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "getEntitiesWithValue((int32,int32,int32))"
  ): TypedContractMethod<[value: CoordStruct], [bigint[]], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "set(uint256,(int32,int32,int32))"
  ): TypedContractMethod<
    [entity: BigNumberish, value: CoordStruct],
    [void],
    "nonpayable"
