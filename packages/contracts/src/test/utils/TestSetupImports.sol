...
abstract contract TestSetupImports is MudTest {
  ...
  function setUp() public virtual override {
    ...
    _IndexRelationshipComponent = IndexRelationshipComponent(
      component(IndexRelationshipComponentID)
    );
    ...
    __RegistryCreateLootboxSystem = _RegistryCreateLootboxSystem(
      system(_RegistryCreateLootboxSystemID)
    );
    ...
    __RegistryCreateQuestObjectiveSystem = _RegistryCreateQuestObjectiveSystem(
      system(_RegistryCreateQuestObjectiveSystemID)
    );
    __RegistryCreateQuestRequirementSystem = _RegistryCreateQuestRequirementSystem(
      system(_RegistryCreateQuestRequirementSystemID)
    );
    __RegistryCreateQuestRewardSystem = _RegistryCreateQuestRewardSystem(
      system(_RegistryCreateQuestRewardSystemID)
    );
    __RegistryCreateRelationshipSystem = _RegistryCreateRelationshipSystem(
      system(_RegistryCreateRelationshipSystemID)
    );
    ...
    __RegistryCreateSkillEffectSystem = _RegistryCreateSkillEffectSystem(
      system(_RegistryCreateSkillEffectSystemID)
    );
    __RegistryCreateSkillRequirementSystem = _RegistryCreateSkillRequirementSystem(
