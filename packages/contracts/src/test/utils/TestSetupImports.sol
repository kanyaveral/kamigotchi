...
import { IndexConditionComponent, ID as IndexConditionComponentID } from "components/IndexConditionComponent.sol";
...
import { QuestCompletionComponent, ID as QuestCompletionComponentID } from "components/QuestCompletionComponent.sol";
...
import { _RegistryCreateConditionSystem, ID as _RegistryCreateConditionSystemID } from "systems/_RegistryCreateConditionSystem.sol";
...
abstract contract TestSetupImports is MudTest {
  ...
  IndexConditionComponent _IndexConditionComponent;
  ...
  IsConditionComponent _IsConditionComponent;
  ...
  QuestCompletionComponent _QuestCompletionComponent;
  ...
  _RegistryCreateConditionSystem __RegistryCreateConditionSystem;
  ...
  function setUp() public virtual override {
    ...
    _IndexConditionComponent = IndexConditionComponent(component(IndexConditionComponentID));
    ...
    _IsConditionComponent = IsConditionComponent(component(IsConditionComponentID));
    ...
    _ProxyPermissionsFarm20Component = ProxyPermissionsFarm20Component(
      component(ProxyPermissionsFarm20ComponentID)
    );
    _ProxyPermissionsERC721Component = ProxyPermissionsERC721Component(
      component(ProxyPermissionsERC721ComponentID)
    );
    _ProxyPermissionsMint20Component = ProxyPermissionsMint20Component(
      component(ProxyPermissionsMint20ComponentID)
    );
    _QuestCompletionComponent = QuestCompletionComponent(component(QuestCompletionComponentID));
    ...
    __RegistryCreateConditionSystem = _RegistryCreateConditionSystem(
      system(_RegistryCreateConditionSystemID)
    );
    ...
    __RegistryCreateReviveSystem = _RegistryCreateReviveSystem(
      system(_RegistryCreateReviveSystemID)
    );
